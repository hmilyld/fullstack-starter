...
public class SystemConfigService {
    ...
    public ApiResponse<?> updateConfig(SystemConfigUpdateRequest req) {
        ...
        if (req.getMaintenanceEnabled() != null) config.setMaintenanceEnabled(req.getMaintenanceEnabled());
        if (req.getMaintenanceMessage() != null) config.setMaintenanceMessage(req.getMaintenanceMessage());
